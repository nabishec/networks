...
related: ["[[802.11 MAC — DCF]]", "[[CSMA-CA|CSMA/CA]]", "[[NAV — Network Allocation Vector]]", "[[RTS-CTS|RTS/CTS]]"]
tags: [networking, ch04]
---
# 802.11 — Wi-Fi архитектура

## TL;DR
IEEE 802.11 — стандарт беспроводных LAN. Базовые элементы: **STA** (станция, клиент), **AP** (access point, точка доступа), **BSS** (Basic Service Set — STA + AP), **ESS** (Extended Service Set — несколько BSS, объединённых одной L2-сетью). Может работать **infrastructure** (через AP) или **ad-hoc** (peer-to-peer без AP). Использует радио в 2.4/5/6 ГГц с MAC-протоколом [[CSMA-CA|CSMA/CA]] + DCF.
...
**MAC-уровень:**
- **Default — DCF** (Distributed Coordination Function): [[CSMA-CA|CSMA/CA]] + random backoff.
...
- **Используется в:** [[802.11 MAC — DCF]], [[CSMA-CA|CSMA/CA]], [[NAV — Network Allocation Vector]], [[RTS-CTS|RTS/CTS]] — конкретные механизмы.
...
- [[RTS-CTS|RTS/CTS]], [[NAV — Network Allocation Vector]] — управление эфиром.
