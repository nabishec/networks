...
## См. также (прикладное)
RF-circumvention: ICMP — last-resort-канал и диагностический инструмент.
- [[PingTunnel — ICMP]] — туннель payload в ICMP Echo (~10 KB/s, last-resort).
- [[TTL-анализ]] — определение позиции ТСПУ через hop-count входящих RST.
- [[PB4 — диагностика whitelist]] — ICMP-пинг как часть диагностики.
